execute store result score @s rr.math.X run data get entity @s Motion[0] 12500
...
execute store result score @s rr.math.X run data get entity @s Motion[1] 12500
...
execute store result score @s rr.math.X run data get entity @s Motion[2] 12500
