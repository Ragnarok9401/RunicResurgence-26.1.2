execute positioned ~ ~0.4375 ~ as @n[type=item_display,distance=..0.1,tag=rr.runic_table.item.5] run item replace entity @s contents with music_disc_cat[jukebox_playable="rr_recast:deep_trouble_2",item_model="rr_recast:disc/music_disc_deep_trouble_2",custom_data={"rr.custom_jukebox_disc":1b,"rr.item":1b},item_name={"text":"Music Disc","color":"aqua"}]
