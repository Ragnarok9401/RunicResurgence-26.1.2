...
execute at @s run data modify storage rr.ui current set from block ~ ~ ~ Items
...
execute if score $bool rr.ui matches 1 run function rr_recast:menu/item_display/on_change