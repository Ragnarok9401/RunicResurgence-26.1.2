...
[\
    ...
    {\
        ...
        "components":\
        {\
            "minecraft:item_name":{"text":"Unrest","color":"dark_red"},\
            lore:[\
                {"color":"gray","italic":false,"text":"Give yourself a break every"},\
                {"color":"gray","italic":false,"text":"so often! If you fire your weapon"},\
                {"color":"gray","italic":false,"text":"too frequently, you'll take damage"},\
                {"color":"gray","italic":false,"text":"and receive some nasty effects."},\
            ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                {"color":"gray","italic":false,"text":"If you fire within a 1.5 second"},\
                {"color":"gray","italic":false,"text":"period after your previous shot,"},\
                {"color":"gray","italic":false,"text":"you'll be afflicted with Nausea for"},\
                {"color":"gray","italic":false,"text":"8 seconds and Hunger 4 for 15 seconds."},\
                {"color":"gray","italic":false,"text":"You'll also take 2.5 True Damage"},\
                {"color":"gray","italic":false,"text":"(hits through Armor, Enchantments, and"},\
                {"color":"gray","italic":false,"text":"Resistance status effect)."},\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"other/enchantments/vice/unrest/open","model":"aea:book/unrest_vice"}'\
                }\
            }\
        }\
    },\
