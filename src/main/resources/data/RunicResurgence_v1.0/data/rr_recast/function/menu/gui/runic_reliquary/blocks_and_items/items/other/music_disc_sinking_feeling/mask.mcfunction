...
[\
    ...
    {\
        ...
        {\
            ...
            "minecraft:jukebox_playable":"rr_recast:sinking_feeling",\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                ...
                {"color":"gray","italic":false,"text":"of 2 when read from a"},\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"blocks_and_items/items/other/music_disc_sinking_feeling/open","model":"rr_recast:disc/music_disc_sinking_feeling"}'\
                }\
            }\
        }\
    },\
