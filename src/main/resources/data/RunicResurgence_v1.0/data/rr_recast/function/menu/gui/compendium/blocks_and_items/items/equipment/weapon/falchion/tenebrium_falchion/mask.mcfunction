...
[\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                ...
                {"color":"gray","italic":false,"text":"Falchion, far more attuned to the"},\
                {"color":"gray","italic":false,"text":"Sculk energy infused with it. It"},\
                {"color":"gray","italic":false,"text":"bolsters a Tenebrium sheen."},\
                ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                [{"color":"gray","italic":false,"text":"Attack Damage: "},{"text":"14","color":"white"}],\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"blocks_and_items/items/equipment/weapon/falchion/tenebrium_falchion/open","model":"rr_recast:equipment/weapon/falchion/tenebrium_falchion"}'\
                }\
            }\
        }\
    },\
