...
[\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                {"color":"gray","italic":false,"text":"A disgusting mass of bone and Sculk."},\
                {"color":"gray","italic":false,"text":"Time has caused its origins to fall out"},\
                {"color":"gray","italic":false,"text":"of human knowledge, but its strength"},\
                {"color":"gray","italic":false,"text":"has always been a source of nightmares."},\
                {"color":"gray","italic":false,"text":"It commands the Sculk infestation like a"},\
                {"color":"gray","italic":false,"text":"war-worn general. Its name is a bit on the"},\
                {"color":"gray","italic":false,"text":"nose, being a mix of Necromancer and Sculk,"},\
                {"color":"gray","italic":false,"text":"but even so, it's an apt description."},\
                ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                ...
                [\
                    {"color":"gray","italic":false,"text":"crafting a "},\
                    {"color":"aqua","italic":false,"text":"Suspicious Dark Heart"},\
                ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                [{"color":"gray","italic":false,"text":"Health: "},{"color":"white","text":"1100"}],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                {"color":"white","italic":false,"text":"Undead Calling:"},\
                {"color":"gray","italic":false,"text":"  Calls forth two sets of either 2 or 3"},\
                ...
                {"color":"white","italic":false,"text":"Tendril Cluster:"},\
                {"color":"gray","italic":false,"text":"  Shoots several Sculk Tendril clusters at"},\
                {"color":"gray","italic":false,"text":"  random players. Each cluster creates five"},\
