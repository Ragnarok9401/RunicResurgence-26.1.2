...
[\
    ...
    {\
        ...
        "components":\
        {\
            "minecraft:item_name":{"text":"Rebound","color":"yellow"},\
            lore:[\
                {"color":"gray","italic":false,"text":"Rebound allows arrows to"},\
                {"color":"gray","italic":false,"text":"bounce off of floors, walls,"},\
                {"color":"gray","italic":false,"text":"and ceilings."},\
            ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                {"color":"gray","italic":false,"text":"Arrows will bounce a number"},\
                {"color":"gray","italic":false,"text":"of times equal to the level"},\
                {"color":"gray","italic":false,"text":"of the enchantment. Some"},\
                {"color":"gray","italic":false,"text":"of the momentum is increased"},\
                {"color":"gray","italic":false,"text":"when bouncing, but this"},\
                {"color":"gray","italic":false,"text":"is a miniscule increase."},\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"other/enchantments/regular/rebound/open","model":"aea:book/rebound_2"}'\
                }\
            }\
        }\
    },\
