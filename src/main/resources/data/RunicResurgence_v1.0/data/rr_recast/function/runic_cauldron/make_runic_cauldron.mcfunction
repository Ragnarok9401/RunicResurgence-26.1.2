# Block Setup
execute as @e[type=item,distance=..10,nbt={OnGround:true,Item:{id:"minecraft:gold_nugget",count:1,components:{"minecraft:custom_model_data":12340,"minecraft:custom_data":{RunicCauldron:true}}}},tag=!RunicCauldronItem] at @s unless entity @n[type=item_display,distance=..9.5,tag=RunicCauldronDisplay] run tag @s add RunicCauldronCreate
