...
execute as @s[tag=RunicRicochet,tag=RunicSpellRun] at @s run data merge entity @n[type=item_display] {interpolation_start:0,interpolation_duration:0,item_display:"head",transformation:{scale:[0.25f,0.25f,0.25f],translation:[0f,1f,0f]}}
