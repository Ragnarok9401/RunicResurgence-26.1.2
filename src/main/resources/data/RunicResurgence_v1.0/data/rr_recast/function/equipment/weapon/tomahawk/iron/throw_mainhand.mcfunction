...
$execute anchored eyes as @s[] run summon item_display ^ ^ ^ {CustomName:[{"text":"Tomahawk","italic":false,"color":"white"}],CustomNameVisible:false,item:$(SelectedItem),teleport_duration:1,transformation:{left_rotation:[0,1,0,1],right_rotation:[0,0,0,1],scale:[0.6,0.6,0.6],translation:[0.25,-0.35,0]},Tags:[rr.entity,rr.tomahawk,rr.tomahawk.setup,rr.tomahawk.iron],item_display:"head"}
