...
execute as @s[scores={rr.system.BossTick=60..},tag=RunicNSULaserB] positioned ^ ^ ^-0.1 run summon marker ~ ~ ~ {Tags:[rr.boss.ns_void.ticking,"RunicNSULaserMB"]}
execute as @s[scores={rr.system.BossTick=60..},tag=RunicNSULaserB] positioned ^ ^ ^-0.1 at @n[type=marker,tag=RunicNSULaserMB,tag=!RunicNSULaserSet] run tp @n[type=marker,tag=RunicNSULaserMB] ~ ~ ~ facing entity @s
execute as @s[scores={rr.system.BossTick=60..},tag=RunicNSULaserB] positioned ^ ^ ^-0.1 at @n[type=marker,tag=RunicNSULaserMB,tag=!RunicNSULaserSet] run tp @n[type=marker,tag=RunicNSULaserMB] ^ ^ ^1.3
...
execute as @s[scores={rr.system.BossTick=60..99}] at @s run tp @s ~ ~ ~ ~1.125 ~
execute as @s[scores={rr.system.BossTick=100..259}] at @s run tp @s ~ ~ ~ ~1.525 ~
execute as @s[scores={rr.system.BossTick=260..300}] at @s run tp @s ~ ~ ~ ~1.125 ~
execute as @s[scores={rr.system.BossTick=310..344}] at @s run tp @s ~ ~ ~ ~-1.125 ~
execute as @s[scores={rr.system.BossTick=345..449}] at @s run tp @s ~ ~ ~ ~-1.525 ~
execute as @s[scores={rr.system.BossTick=450..}] at @s run tp @s ~ ~ ~ ~-1.125 ~

tag @e[type=marker,tag=RunicNSULaserMB,tag=!RunicNSULaserSet] add RunicNSULaserSet

execute as @s[scores={rr.system.BossTick=100}] at @s run execute as @a[distance=..40,tag=rr.player.in_boss_fight] at @s run playsound minecraft:entity.warden.attack_impact hostile @s ~ ~ ~ 0.85 1.5 0
execute as @s[scores={rr.system.BossTick=260}] at @s run execute as @a[distance=..40,tag=rr.player.in_boss_fight] at @s run playsound minecraft:entity.warden.attack_impact hostile @s ~ ~ ~ 0.85 1 0
execute as @s[scores={rr.system.BossTick=345}] at @s run execute as @a[distance=..40,tag=rr.player.in_boss_fight] at @s run playsound minecraft:entity.warden.attack_impact hostile @s ~ ~ ~ 0.85 1.5 0
execute as @s[scores={rr.system.BossTick=450}] at @s run execute as @a[distance=..40,tag=rr.player.in_boss_fight] at @s run playsound minecraft:entity.warden.attack_impact hostile @s ~ ~ ~ 0.85 1 0
