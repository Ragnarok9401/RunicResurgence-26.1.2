...
[\
    ...
    {\
        ...
        "components":\
        {\
            "minecraft:item_name":{"text":"Enlarge","color":"yellow"},\
            lore:[\
                {"color":"gray","italic":false,"text":"When wearing a piece of armor"},\
                {"color":"gray","italic":false,"text":"with Enlarge, you become bigger"},\
                {"color":"gray","italic":false,"text":"and have increased Jump Height,"},\
                ...
                {"color":"gray","italic":false,"text":"However, your Speed is reduced."},\
            ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                {"color":"gray","italic":false,"text":"Each level adds to every"},\
                ...
                {"color":"gray","italic":false,"text":"level, you are twice your regular size."},\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"other/enchantments/regular/enlarge/open","model":"aea:book/enlarge_4"}'\
                }\
            }\
        }\
    },\
