...
[\
    ...
    {\
        ...
        {\
            ...
            "minecraft:jukebox_playable":"rr_recast:deep_trouble",\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                ...
                {"color":"gray","italic":false,"text":"of 3 when read from a"},\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"blocks_and_items/items/other/music_disc_deep_trouble/open","model":"rr_recast:disc/music_disc_deep_trouble"}'\
                }\
            }\
        }\
    },\
