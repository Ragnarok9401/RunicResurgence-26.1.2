...
playsound minecraft:entity.ender_eye.death player @a[distance=..15] ~ ~ ~ 0.9 1.50625 0
...
summon interaction ~ ~ ~ {width:0.25f,height:0.25f,response:true,Tags:[aea.altar.entity,"ArenAEASharpnessUp2","ArenAEAIMain"]}
kill @s