...
# Adding a level costs 22 * (target level - current level) + (8 * current level)
execute as @s at @s if score @s aea.system.level_base matches 0 if score @s aea.system.level_difference matches 1 run scoreboard players set @s aea.math.H 14
execute as @s at @s if score @s aea.system.level_base matches 0 if score @s aea.system.level_difference matches 2 run scoreboard players set @s aea.math.H 30

execute as @s at @s if score @s aea.system.level_base matches 1 if score @s aea.system.level_difference matches 1 run scoreboard players set @s aea.math.H 20
