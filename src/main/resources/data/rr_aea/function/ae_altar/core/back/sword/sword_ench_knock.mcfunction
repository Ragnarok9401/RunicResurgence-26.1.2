execute as @s at @s positioned ~ ~1 ~ run function rr_aea:ae_altar/core/enchants_display/sword_display
...
execute as @s at @s run kill @e[type=text_display,tag=ArenAEAKnockbackLvlText,distance=..5]
execute as @s at @s run kill @e[type=item_display,tag=ArenAEAKnockbackLvl,distance=..5]
execute as @s at @s run kill @e[type=item_display,tag=ArenAEAKnockbackUp1,distance=..5]
execute as @s at @s run kill @e[type=item_display,tag=ArenAEAKnockbackUp2,distance=..5]
execute as @s at @s run kill @e[type=item_display,tag=ArenAEAKnockbackDown1,distance=..5]
execute as @s at @s run kill @e[type=item_display,tag=ArenAEAKnockbackDown2,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAKnockbackUp1,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAKnockbackUp2,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAKnockbackDown1,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAKnockbackDown2,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAKnockbackConfirm,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAKnockbackConfirm2,distance=..5]
