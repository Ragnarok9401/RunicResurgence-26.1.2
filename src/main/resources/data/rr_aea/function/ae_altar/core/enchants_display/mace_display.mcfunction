# List of Enchantments for Mace:
#region

## Concussing - Inflict Nausea on hit, helmets reduce chance/length
##     For mobs: Cause them to be either stunned or move around as though they're dizzy, use blindness to reduce follow range
