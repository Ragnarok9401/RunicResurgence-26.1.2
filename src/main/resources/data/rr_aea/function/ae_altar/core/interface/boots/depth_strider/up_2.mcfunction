...
playsound minecraft:entity.ender_eye.death player @a[distance=..15] ~ ~ ~ 0.9 1.25 0
...
summon interaction ~ ~ ~ {width:0.25f,height:0.25f,response:true,Tags:[aea.altar.entity,"ArenAEADepthUp2","ArenAEAIMain"]}
kill @s