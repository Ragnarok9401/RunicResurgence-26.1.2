...
execute as @s at @s run kill @e[type=text_display,tag=ArenAEAFireLvlText,distance=..5]
execute as @s at @s run kill @e[type=item_display,tag=ArenAEAFireLvl,distance=..5]
execute as @s at @s run kill @e[type=item_display,tag=ArenAEAFireUp1,distance=..5]
execute as @s at @s run kill @e[type=item_display,tag=ArenAEAFireUp2,distance=..5]
execute as @s at @s run kill @e[type=item_display,tag=ArenAEAFireDown1,distance=..5]
execute as @s at @s run kill @e[type=item_display,tag=ArenAEAFireDown2,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAFireUp1,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAFireUp2,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAFireDown1,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAFireDown2,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAFireConfirm,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAFireConfirm2,distance=..5]
