...
# Adding a level costs 18 * (target level - current level) + (6 * current level)
execute as @s at @s if score @s aea.system.level_base matches 0 if score @s aea.system.level_difference matches 1 run scoreboard players set @s aea.math.H 12
execute as @s at @s if score @s aea.system.level_base matches 0 if score @s aea.system.level_difference matches 2 run scoreboard players set @s aea.math.H 24
execute as @s at @s if score @s aea.system.level_base matches 0 if score @s aea.system.level_difference matches 3 run scoreboard players set @s aea.math.H 36

execute as @s at @s if score @s aea.system.level_base matches 1 if score @s aea.system.level_difference matches 1 run scoreboard players set @s aea.math.H 16
execute as @s at @s if score @s aea.system.level_base matches 1 if score @s aea.system.level_difference matches 2 run scoreboard players set @s aea.math.H 28

execute as @s at @s if score @s aea.system.level_base matches 2 if score @s aea.system.level_difference matches 1 run scoreboard players set @s aea.math.H 20
