...
execute as @a at @s run function sbhp:technical/health/regenerate_health_5t
...
execute if score $config sbhp.config.TickSpeedMode matches 5 run schedule function sbhp:technical/5tick 5t