...
scoreboard objectives add rr.system.dmg_taken custom:damage_taken
...
## BaseDmgMod - Base Damage Modification (default is 115%--or +15%--damage taken from all (vanilla) sources)
scoreboard objectives add sbhp.config.BaseDmgMod dummy
execute unless score $config sbhp.config.BaseDmgMod matches 0.. run scoreboard players set $config sbhp.config.BaseDmgMod 100
...
execute as @a at @s store result score @s sbhp.PlayerUUID1 run data get entity @s UUID[0]
execute as @a at @s store result score @s sbhp.PlayerUUID2 run data get entity @s UUID[1]
execute as @a at @s store result score @s sbhp.PlayerUUID3 run data get entity @s UUID[2]
execute as @a at @s store result score @s sbhp.PlayerUUID4 run data get entity @s UUID[3]

execute as @e at @s run scoreboard players operation @s sbhp.HPDwn1 = @s sbhp.HealthCurr
execute as @e at @s run scoreboard players remove @s sbhp.HPDwn1 1
