...
execute as @s[tag=rr.spell.magic_bolt] at @s run function rr_recast:spells/core/functions/projectile/general/windup_tick with storage rr_recast:global spells.magic_bolt.projectile
