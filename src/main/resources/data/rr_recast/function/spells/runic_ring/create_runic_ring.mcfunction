...
##region
### Int 1
execute as @e[distance=..0.08,limit=1,sort=nearest,type=interaction,tag=RunicStandSetup,tag=RunicStand1,tag=RunicStandInteraction] at @s run execute at @e[type=marker,tag=RunicRotationMarker,limit=1,sort=nearest,distance=..0.1] run tp @s ^ ^2.618 ^2

### Int 2
execute as @e[distance=..0.08,limit=1,sort=nearest,type=interaction,tag=RunicStandSetup,tag=RunicStand2,tag=RunicStandInteraction] at @s run execute at @e[type=marker,tag=RunicRotationMarker,limit=1,sort=nearest,distance=..0.1] run tp @s ^-0.791 ^2.291 ^2

### Int 3
execute as @e[distance=..0.08,limit=1,sort=nearest,type=interaction,tag=RunicStandSetup,tag=RunicStand3,tag=RunicStandInteraction] at @s run execute at @e[type=marker,tag=RunicRotationMarker,limit=1,sort=nearest,distance=..0.1] run tp @s ^-1.118 ^1.5 ^2

### Int 4
execute as @e[distance=..0.08,limit=1,sort=nearest,type=interaction,tag=RunicStandSetup,tag=RunicStand4,tag=RunicStandInteraction] at @s run execute at @e[type=marker,tag=RunicRotationMarker,limit=1,sort=nearest,distance=..0.1] run tp @s ^-0.791 ^0.709 ^2

### Int 5
execute as @e[distance=..0.08,limit=1,sort=nearest,type=interaction,tag=RunicStandSetup,tag=RunicStand5,tag=RunicStandInteraction] at @s run execute at @e[type=marker,tag=RunicRotationMarker,limit=1,sort=nearest,distance=..0.1] run tp @s ^ ^0.382 ^2

### Int 6
execute as @e[distance=..0.08,limit=1,sort=nearest,type=interaction,tag=RunicStandSetup,tag=RunicStand6,tag=RunicStandInteraction] at @s run execute at @e[type=marker,tag=RunicRotationMarker,limit=1,sort=nearest,distance=..0.1] run tp @s ^0.791 ^0.709 ^2

### Int 7
execute as @e[distance=..0.08,limit=1,sort=nearest,type=interaction,tag=RunicStandSetup,tag=RunicStand7,tag=RunicStandInteraction] at @s run execute at @e[type=marker,tag=RunicRotationMarker,limit=1,sort=nearest,distance=..0.1] run tp @s ^1.118 ^1.5 ^2

### Int 8
execute as @e[distance=..0.08,limit=1,sort=nearest,type=interaction,tag=RunicStandSetup,tag=RunicStand8,tag=RunicStandInteraction] at @s run execute at @e[type=marker,tag=RunicRotationMarker,limit=1,sort=nearest,distance=..0.1] run tp @s ^0.791 ^2.291 ^2

### Int 9
execute as @e[distance=..0.08,limit=1,sort=nearest,type=interaction,tag=RunicStandSetup,tag=RunicStand9,tag=RunicStandInteraction] at @s run execute at @e[type=marker,tag=RunicRotationMarker,limit=1,sort=nearest,distance=..0.1] run tp @s ^ ^1.5 ^2
...
execute as @e[type=interaction,tag=RunicStandSetup,tag=RunicStand1,limit=1,sort=nearest,distance=..4] at @s rotated as @s run tp @n[type=item_display,tag=RunicIndicator1,distance=..0.1] ~ ~ ~ facing entity @p[tag=!rr.player.sneaking_consecutive,tag=rr.player.sneaking_initial] eyes
...
execute as @e[type=interaction,tag=RunicStandSetup,tag=RunicStand2,limit=1,sort=nearest,distance=..4] at @s rotated as @s run tp @n[type=item_display,tag=RunicIndicator2,distance=..0.1] ~ ~ ~ facing entity @p[tag=!rr.player.sneaking_consecutive,tag=rr.player.sneaking_initial] eyes
...
execute as @e[type=interaction,tag=RunicStandSetup,tag=RunicStand3,limit=1,sort=nearest,distance=..4] at @s rotated as @s run tp @n[type=item_display,tag=RunicIndicator3,distance=..0.1] ~ ~ ~ facing entity @p[tag=!rr.player.sneaking_consecutive,tag=rr.player.sneaking_initial] eyes
...
execute as @e[type=interaction,tag=RunicStandSetup,tag=RunicStand4,limit=1,sort=nearest,distance=..4] at @s rotated as @s run tp @n[type=item_display,tag=RunicIndicator4,distance=..0.1] ~ ~ ~ facing entity @p[tag=!rr.player.sneaking_consecutive,tag=rr.player.sneaking_initial] eyes
...
execute as @e[type=interaction,tag=RunicStandSetup,tag=RunicStand5,limit=1,sort=nearest,distance=..4] at @s rotated as @s run tp @n[type=item_display,tag=RunicIndicator5,distance=..0.1] ~ ~ ~ facing entity @p[tag=!rr.player.sneaking_consecutive,tag=rr.player.sneaking_initial] eyes
...
execute as @e[type=interaction,tag=RunicStandSetup,tag=RunicStand6,limit=1,sort=nearest,distance=..4] at @s rotated as @s run tp @n[type=item_display,tag=RunicIndicator6,distance=..0.1] ~ ~ ~ facing entity @p[tag=!rr.player.sneaking_consecutive,tag=rr.player.sneaking_initial] eyes
...
execute as @e[type=interaction,tag=RunicStandSetup,tag=RunicStand7,limit=1,sort=nearest,distance=..4] at @s rotated as @s run tp @n[type=item_display,tag=RunicIndicator7,distance=..0.1] ~ ~ ~ facing entity @p[tag=!rr.player.sneaking_consecutive,tag=rr.player.sneaking_initial] eyes
...
execute as @e[type=interaction,tag=RunicStandSetup,tag=RunicStand8,limit=1,sort=nearest,distance=..4] at @s rotated as @s run tp @n[type=item_display,tag=RunicIndicator8,distance=..0.1] ~ ~ ~ facing entity @p[tag=!rr.player.sneaking_consecutive,tag=rr.player.sneaking_initial] eyes
...
execute as @e[type=interaction,tag=RunicStandSetup,tag=RunicStand9,limit=1,sort=nearest,distance=..4] at @s rotated as @s run tp @n[type=item_display,tag=RunicIndicator9,distance=..0.1] ~ ~-0 ~ facing entity @p[tag=!rr.player.sneaking_consecutive,tag=rr.player.sneaking_initial] eyes
