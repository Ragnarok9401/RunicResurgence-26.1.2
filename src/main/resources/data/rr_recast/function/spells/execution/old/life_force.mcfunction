...
execute as @s[tag=RunicLifeForce,tag=RunicSpellRun,tag=RunicMaxLifeD,tag=!RunicSilentSpells] at @s run playsound minecraft:block.iron_chain.place master @a[distance=..30] ~ ~ ~ 1.75 0.45 0
...
execute as @s[tag=RunicLifeForce,tag=RunicSpellRun,tag=RunicMaxLifeC,tag=!RunicSilentSpells] at @s run playsound minecraft:block.iron_chain.place master @a[distance=..30] ~ ~ ~ 1.7 0.55 0
...
execute as @s[tag=RunicLifeForce,tag=RunicSpellRun,tag=RunicMaxLifeB,tag=!RunicSilentSpells] at @s run playsound minecraft:block.iron_chain.place master @a[distance=..30] ~ ~ ~ 1.65 0.65 0
...
execute as @s[tag=RunicLifeForce,tag=RunicSpellRun,tag=RunicMaxLifeA,tag=!RunicSilentSpells] at @s run playsound minecraft:block.iron_chain.place master @a[distance=..30] ~ ~ ~ 1.55 0.75 0
...
execute as @s[tag=RunicLifeForce,tag=RunicSpellRun,tag=RunicMidLife,tag=!RunicSilentSpells] at @s run playsound minecraft:block.iron_chain.place master @a[distance=..30] ~ ~ ~ 1.45 0.9 0
...
execute as @s[tag=RunicLifeForce,tag=RunicSpellRun,tag=RunicLowLife,tag=!RunicSilentSpells] at @s run playsound minecraft:block.iron_chain.place master @a[distance=..30] ~ ~ ~ 1.2 1.15 0
...
execute as @s[tag=RunicLifeForce,tag=RunicSpellRun,tag=!RunicMaxLifeD,tag=!RunicMaxLifeC,tag=!RunicMaxLifeB,tag=!RunicMaxLifeA,tag=!RunicMidLife,tag=!RunicLowLife,tag=!RunicSilentSpells] at @s run playsound minecraft:block.iron_chain.place master @a[distance=..30] ~ ~ ~ 1.05 1.4 0
