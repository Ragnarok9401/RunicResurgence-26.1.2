...
execute as @s[scores={rr.system.BossTick=60..},tag=RunicNSLaserB] positioned ^ ^ ^-0.1 run summon marker ~ ~ ~ {Tags:["rr.boss.ns.ticking","RunicNSLaserMB"]}
execute as @s[scores={rr.system.BossTick=60..},tag=RunicNSLaserB] positioned ^ ^ ^-0.1 at @n[type=marker,tag=RunicNSLaserMB,tag=!RunicNSLaserSet] run tp @n[type=marker,tag=RunicNSLaserMB] ~ ~ ~ facing entity @s
execute as @s[scores={rr.system.BossTick=60..},tag=RunicNSLaserB] positioned ^ ^ ^-0.1 at @n[type=marker,tag=RunicNSLaserMB,tag=!RunicNSLaserSet] run tp @n[type=marker,tag=RunicNSLaserMB] ^ ^ ^1.3
...
execute as @s[scores={rr.system.BossTick=60..99}] at @s run tp @s ~ ~ ~ ~0.6 ~
execute as @s[scores={rr.system.BossTick=100..259}] at @s run tp @s ~ ~ ~ ~0.9 ~
execute as @s[scores={rr.system.BossTick=260..300}] at @s run tp @s ~ ~ ~ ~0.6 ~
execute as @s[scores={rr.system.BossTick=310..344}] at @s run tp @s ~ ~ ~ ~-0.6 ~
execute as @s[scores={rr.system.BossTick=345..449}] at @s run tp @s ~ ~ ~ ~-0.9 ~
execute as @s[scores={rr.system.BossTick=450..}] at @s run tp @s ~ ~ ~ ~-0.6 ~

tag @e[type=marker,tag=RunicNSLaserMB,tag=!RunicNSLaserSet] add RunicNSLaserSet
