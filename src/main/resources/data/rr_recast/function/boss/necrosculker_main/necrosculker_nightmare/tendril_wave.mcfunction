...
#region
execute store result score @s rr.math.A run random value 1..6
...
execute if score @s rr.math.A matches 1 at @s run function rr_recast:boss/necrosculker_main/necrosculker_nightmare/tendril_wave/single_line with entity @s data.rr_recast.tendril_wave
execute if score @s rr.math.A matches 2 at @s run function rr_recast:boss/necrosculker_main/necrosculker_nightmare/tendril_wave/double_line with entity @s data.rr_recast.tendril_wave
execute if score @s rr.math.A matches 3 at @s run function rr_recast:boss/necrosculker_main/necrosculker_nightmare/tendril_wave/ring_out with entity @s data.rr_recast.tendril_wave
execute if score @s rr.math.A matches 4 at @s run function rr_recast:boss/necrosculker_main/necrosculker_nightmare/tendril_wave/ring_in with entity @s data.rr_recast.tendril_wave
execute if score @s rr.math.A matches 5 at @s run function rr_recast:boss/necrosculker_main/necrosculker_nightmare/tendril_wave/spiral_out with entity @s data.rr_recast.tendril_wave
execute if score @s rr.math.A matches 6 at @s run function rr_recast:boss/necrosculker_main/necrosculker_nightmare/tendril_wave/spiral_in with entity @s data.rr_recast.tendril_wave