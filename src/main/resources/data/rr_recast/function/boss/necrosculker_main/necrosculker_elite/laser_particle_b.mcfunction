...
execute as @s[scores={rr.system.BossTick=40}] at @s run execute as @a[distance=..40,tag=rr.player.in_boss_fight] at @s run playsound minecraft:block.end_portal_frame.fill hostile @s[distance=..60] ~ ~ ~ 0.85 1.2 0
execute as @s[scores={rr.system.BossTick=45}] at @s run execute as @a[distance=..40,tag=rr.player.in_boss_fight] at @s run playsound minecraft:block.end_portal_frame.fill hostile @s[distance=..60] ~ ~ ~ 0.85 1.4 0
...
execute as @s[scores={rr.system.BossTick=55}] at @s run execute as @a[distance=..40,tag=rr.player.in_boss_fight] at @s run playsound minecraft:block.end_portal_frame.fill hostile @s[distance=..60] ~ ~ ~ 0.85 1.9 0
...
execute as @s[scores={rr.system.BossTick=60..},tag=RunicNSELaserB] positioned ^ ^ ^-0.1 run summon marker ~ ~ ~ {Tags:[rr.boss.ns_elite.ticking,"RunicNSELaserMB"]}
execute as @s[scores={rr.system.BossTick=60..},tag=RunicNSELaserB] positioned ^ ^ ^-0.1 at @n[type=marker,tag=RunicNSELaserMB,tag=!RunicNSELaserSet] run tp @n[type=marker,tag=RunicNSELaserMB] ~ ~ ~ facing entity @s
execute as @s[scores={rr.system.BossTick=60..},tag=RunicNSELaserB] positioned ^ ^ ^-0.1 at @n[type=marker,tag=RunicNSELaserMB,tag=!RunicNSELaserSet] run tp @n[type=marker,tag=RunicNSELaserMB] ^ ^ ^1.3
...
execute as @s[scores={rr.system.BossTick=60..99}] at @s run tp @s ~ ~ ~ ~0.75 ~
execute as @s[scores={rr.system.BossTick=100..259}] at @s run tp @s ~ ~ ~ ~1.15 ~
execute as @s[scores={rr.system.BossTick=260..300}] at @s run tp @s ~ ~ ~ ~0.75 ~
execute as @s[scores={rr.system.BossTick=310..344}] at @s run tp @s ~ ~ ~ ~-0.75 ~
execute as @s[scores={rr.system.BossTick=345..449}] at @s run tp @s ~ ~ ~ ~-1.15 ~
execute as @s[scores={rr.system.BossTick=450..}] at @s run tp @s ~ ~ ~ ~-0.75 ~

tag @e[type=marker,tag=RunicNSELaserMB,tag=!RunicNSELaserSet] add RunicNSELaserSet
