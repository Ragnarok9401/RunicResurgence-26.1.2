...
title @s[scores={rr.boss.title_display=18}] subtitle [{"text":"[ ","color":"#5387D6","italic":false,"font":"alagard",shadow_color:0},{"text":"⭐⭐⭐","color":"#ffd900","italic":false,"font":"minecraft:default"},{"text":" ]","color":"#5387D6","italic":false,"font":"alagard",shadow_color:0}]

title @s[scores={rr.boss.title_display=23}] times 0 40 40
title @s[scores={rr.boss.title_display=23}] title {"text":"N e c r o s c u l k e r","color":"#5387D6","italic":false,"font":"alagard",shadow_color:0}
title @s[scores={rr.boss.title_display=23}] subtitle {"text":"The Desolate Destroyer","color":"#5387D6","italic":false,"font":"alagard",shadow_color:0}
...
execute as @s[scores={rr.boss.title_display=23}] at @s run function rr_recast:cutscene/sfx/text_impact_3
execute as @s[scores={rr.boss.title_display=23}] at @s run tag @s remove rr.boss.necrosculker_nightmare.title_display