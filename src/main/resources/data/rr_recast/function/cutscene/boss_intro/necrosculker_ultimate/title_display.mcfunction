...
title @s[scores={rr.boss.title_display=18}] title {"text":"N e c r o s c u l k e r","color":"#5387D6","italic":false,"font":"alagard",shadow_color:0}
title @s[scores={rr.boss.title_display=18}] subtitle [{"text":"[ ","color":"#5387D6","italic":false,"font":"alagard",shadow_color:0},{"text":"⭐⭐⭐","color":"gold","italic":false,"font":"minecraft:default"},{"text":" ]","color":"#5387D6","italic":false,"font":"alagard",shadow_color:0}]
title @s[scores={rr.boss.title_display=20}] title {"text":"N e c r o s c u l k e r","color":"dark_red","italic":false,"font":"alagard",shadow_color:0}
title @s[scores={rr.boss.title_display=20}] subtitle [{"text":"[ ","color":"dark_red","italic":false,"font":"alagard",shadow_color:0},{"text":"⭐","color":"red","italic":false,"font":"minecraft:default"},{"text":" ]","color":"dark_red","italic":false,"font":"alagard",shadow_color:0}]

title @s[scores={rr.boss.title_display=25}] times 0 40 40
title @s[scores={rr.boss.title_display=25}] title {"text":"N e c r o s c u l k e r","color":"dark_red","italic":false,"font":"alagard",shadow_color:0}
title @s[scores={rr.boss.title_display=25}] subtitle {"text":"The Forsaken Titan","color":"dark_red","italic":false,"font":"alagard",shadow_color:0}
...
execute as @s[scores={rr.boss.title_display=18}] at @s run function rr_recast:cutscene/sfx/text_impact_3
execute as @s[scores={rr.boss.title_display=20}] at @s run function rr_recast:cutscene/sfx/text_impact_4
execute as @s[scores={rr.boss.title_display=25}] at @s run function rr_recast:cutscene/sfx/text_impact_4
execute as @s[scores={rr.boss.title_display=25}] at @s run tag @s remove rr.boss.necrosculker_ultimate.title_display