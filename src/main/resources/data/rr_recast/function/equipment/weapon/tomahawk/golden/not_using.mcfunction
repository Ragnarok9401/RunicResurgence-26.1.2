...
execute as @s[predicate=rr_recast:held_items/any/equipment/weapon/tomahawk/golden_tomahawk,predicate=rr_recast:held_items/mainhand/equipment/weapon/tomahawk/golden_tomahawk,scores={rr.player.tomahawk_charge=15..}] at @s run function rr_recast:equipment/weapon/tomahawk/golden/throw_mainhand with entity @s
execute as @s[predicate=rr_recast:held_items/any/equipment/weapon/tomahawk/golden_tomahawk,predicate=rr_recast:held_items/offhand/equipment/weapon/tomahawk/golden_tomahawk,predicate=!rr_recast:held_items/mainhand/equipment/weapon/tomahawk/golden_tomahawk,scores={rr.player.tomahawk_charge=15..}] at @s run function rr_recast:equipment/weapon/tomahawk/golden/throw_offhand with entity @s equipment
