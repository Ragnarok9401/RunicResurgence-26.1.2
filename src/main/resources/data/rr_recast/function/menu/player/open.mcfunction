...
summon item_display ~ ~1.25 ~ {view_range:0f,width:0f,height:0f,teleport_duration:0,Tags:["RunicUI","RunicUISetup"],Passengers:[{id:"minecraft:chest_minecart",DisplayState:{Name:"minecraft:barrier"},Invulnerable:1b,Tags:["RunicUI","RunicUISetup","invisible_minecart"],CustomNameVisible:0b,CustomName:"",Passengers:[{id:"minecraft:marker",Tags:["RunicUI","RunicUISetup"]}]}]}
