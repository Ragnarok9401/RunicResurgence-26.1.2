...
[\
    ...
    {\
        ...
        {\
            ...
            [\
                ...
                {"text":"    Netherite Leggings","color":"green","italic":false},\
            ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                [{"color":"gray","italic":false,"text":"Armor: "},{"text":"7","color":"white"}],\
                ...
                [{"color":"gray","italic":false,"text":"Durability: "},{"text":"622","color":"white"}],\
            ],\
    ...
    {\
        ...
        {\
            tooltip_display:{hide_tooltip:true},\
            "minecraft:custom_data":{RunicMenuItem:{empty:1b}},\
            item_model:"rr_recast:menu/compendium/icons/tenebrium_armor_alt_recipe_leggings",\
            "!minecraft:jukebox_playable":{},\
        }\
    },\
    {\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"blocks_and_items/items/equipment/armor/tenebrium/tenebrium_leggings/open","model":"rr_recast:equipment/armor/sculk_plate/sculk_plate_leggings"}'\
                }\
            }\
        }\
    },\
