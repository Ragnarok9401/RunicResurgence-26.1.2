...
[\
    ...
    {\
        ...
        "components":\
        {\
            "minecraft:item_name":{"text":"Recursion","color":"light_purple"},\
            lore:[\
                {"color":"gray","italic":false,"text":"Give your shots some repeat"},\
                {"color":"gray","italic":false,"text":"offenders! Recursion allows"},\
                {"color":"gray","italic":false,"text":"your bow to create exact"},\
                {"color":"gray","italic":false,"text":"duplicates of arrows you fire."},\
            ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                {"color":"gray","italic":false,"text":"Each level of Recursion creates"},\
                {"color":"gray","italic":false,"text":"an additional duplicate of any"},\
                {"color":"gray","italic":false,"text":"arrow(s) fired. Duplicates of the"},\
                {"color":"gray","italic":false,"text":"main arrow may not be picked up."},\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"other/enchantments/blessing/recursion/open","model":"aea:book/recursion_3"}'\
                }\
            }\
        }\
    },\
