...
[\
    ...
    {\
        ...
        "components":\
        {\
            "minecraft:item_name":{"text":"Titanism","color":"light_purple"},\
            lore:[\
                {"color":"gray","italic":false,"text":"Become a force of nature!"},\
                {"color":"gray","italic":false,"text":"Titanism ludicrously boosts"},\
                {"color":"gray","italic":false,"text":"your damage and causes more"},\
                {"color":"gray","italic":false,"text":"knockback, but heavily reduces"},\
                {"color":"gray","italic":false,"text":"your mobility in turn."},\
            ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                {"color":"gray","italic":false,"text":"Titanism causes 5x damage and"},\
                {"color":"gray","italic":false,"text":"50% more knockback in total."},\
                {"color":"gray","italic":false,"text":"However, you lose the ability to"},\
                {"color":"gray","italic":false,"text":"jump and 80% of your total speed."},\
                {"color":"gray","italic":false,"text":"Additionally, there is a forced"},\
                {"color":"gray","italic":false,"text":"attack cooldown which cannot be"},\
                {"color":"gray","italic":false,"text":"reduced."},\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"other/enchantments/blessing/titanism/open","model":"aea:book/titanism_blessing"}'\
                }\
            }\
        }\
    },\
