...
[\
    ...
    {\
        ...
        "components":\
        {\
            "minecraft:item_name":{"text":"Maul","color":"yellow"},\
            lore:[\
                {"color":"gray","italic":false,"text":"Maul reduces the invulnerability"},\
                {"color":"gray","italic":false,"text":"period of an entity after they"},\
                {"color":"gray","italic":false,"text":"are hit."},\
            ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                {"color":"gray","italic":false,"text":"Maul reduces the invulnerability"},\
                {"color":"gray","italic":false,"text":"period by roughly 1 gametick per level,"},\
                {"color":"gray","italic":false,"text":"with the max level reducing the period"},\
                {"color":"gray","italic":false,"text":"down to only 2 ticks of invulnerability."},\
                {"color":"gray","italic":false,"text":"Applicable on: "},\
                {"color":"white","italic":false,"text":"  Swords, Axes"},\
                [{"color":"gray","italic":false,"text":"Max Level: "},{"text":"8","color":"white"}],\
            ],\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"other/enchantments/regular/maul/open","model":"aea:book/maul_8"}'\
                }\
            }\
        }\
    },\
