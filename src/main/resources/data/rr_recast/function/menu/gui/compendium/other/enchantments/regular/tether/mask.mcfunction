...
[\
    ...
    {\
        ...
        "components":\
        {\
            "minecraft:item_name":{"text":"Tether","color":"yellow"},\
            lore:[\
                {"color":"gray","italic":false,"text":"Tether allows you to take"},\
                {"color":"gray","italic":false,"text":"a ride alongside your arrows."},\
            ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                {"color":"gray","italic":false,"text":"Firing while Sneaking"},\
                {"color":"gray","italic":false,"text":"does not tether you to"},\
                {"color":"gray","italic":false,"text":"your arrow."},\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"other/enchantments/regular/tether/open","model":"aea:book/tether"}'\
                }\
            }\
        }\
    },\
