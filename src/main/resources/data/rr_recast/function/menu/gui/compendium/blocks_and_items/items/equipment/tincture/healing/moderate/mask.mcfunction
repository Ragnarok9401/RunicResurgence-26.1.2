...
[\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                {"color":"gray","italic":false,"text":"More infusion, more potency."},\
                {"color":"gray","italic":false,"text":"Now with curative effects!"},\
                ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                ...
                {"color":"white","italic":false,"text":"    100 HP over 10 Seconds"},\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"blocks_and_items/items/equipment/tincture/healing/moderate/open","model":"sbhp:tincture/health_3"}'\
                }\
            }\
        }\
    },\
