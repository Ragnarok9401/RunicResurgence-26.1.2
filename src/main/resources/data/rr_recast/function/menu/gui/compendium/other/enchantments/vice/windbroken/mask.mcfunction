...
[\
    ...
    {\
        ...
        "components":\
        {\
            "minecraft:item_name":{"text":"Windbroken","color":"dark_red"},\
            lore:[\
                {"color":"gray","italic":false,"text":"Your echoes are muffled!"},\
                {"color":"gray","italic":false,"text":"Echo clouds you create will begin to"},\
                {"color":"gray","italic":false,"text":"lose strength as they travel and"},\
                {"color":"gray","italic":false,"text":"damage things."},\
            ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                {"color":"gray","italic":false,"text":"Echo clouds will lose 10% of"},\
                {"color":"gray","italic":false,"text":"their damage each time an"},\
                {"color":"gray","italic":false,"text":"entity is hit, but only 10%"},\
                {"color":"gray","italic":false,"text":"per tick regardless of how many"},\
                {"color":"gray","italic":false,"text":"entities are hit at once. Further,"},\
                {"color":"gray","italic":false,"text":"Echo clouds will lose 2.5% of"},\
                {"color":"gray","italic":false,"text":"their speed per tick."},\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"other/enchantments/vice/windbroken/open","model":"aea:book/windbroken_vice"}'\
                }\
            }\
        }\
    },\
