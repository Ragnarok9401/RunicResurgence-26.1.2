...
[\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                {"color":"gray","italic":false,"text":"Some ancient enchanted crest"},\
                {"color":"gray","italic":false,"text":"infused with Sculk energy."},\
                {"color":"gray","italic":false,"text":"Its magic has become a perfect"},\
                {"color":"gray","italic":false,"text":"blend of Chaos and Darkness,"},\
                {"color":"gray","italic":false,"text":"allowing it to be used for"},\
                {"color":"gray","italic":false,"text":"highly desirable items."},\
            ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                ...
                {"color":"gray","italic":false,"text":"as a rare drop."},\
            ],\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"blocks_and_items/items/materials/necrosculker_crest/open","model":"rr_recast:mob_drop/deep_dark_crest"}'\
                }\
            }\
        }\
    },\
