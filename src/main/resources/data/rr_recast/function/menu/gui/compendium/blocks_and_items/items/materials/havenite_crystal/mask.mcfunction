...
[\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                {"color":"gray","italic":false,"text":"A collection of Havenite Shards"},\
                {"color":"gray","italic":false,"text":"in a beautiful circular array."},\
                ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                {"color":"gray","italic":false,"text":"Used as a catalyst"},\
                {"color":"gray","italic":false,"text":"for Chaos magic. The"},\
                {"color":"gray","italic":false,"text":"basis for all Runic Tablets."},\
            ],\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"blocks_and_items/items/materials/havenite_crystal/open","model":"rr_recast:havenite/havenite_crystal"}'\
                }\
            }\
        }\
    },\
