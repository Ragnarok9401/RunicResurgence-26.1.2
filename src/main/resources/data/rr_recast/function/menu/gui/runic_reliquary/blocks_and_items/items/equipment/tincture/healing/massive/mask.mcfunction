...
[\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                {"color":"gray","italic":false,"text":"The End-all be-all of the healing"},\
                {"color":"gray","italic":false,"text":"tinctures. It's said that even the"},\
                {"color":"gray","italic":false,"text":"gods themselves enjoyed these from"},\
                {"color":"gray","italic":false,"text":"time to time."},\
                ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                ...
                {"color":"white","italic":false,"text":"    400 HP over 10 Seconds"},\
    ...
    {\
        ...
        {\
            tooltip_display:{hide_tooltip:true},\
            "minecraft:custom_data":{RunicMenuItem:{empty:1b}},\
            item_model:"minecraft:chorus_fruit",\
            "!minecraft:jukebox_playable":{},\
        }\
    },\
    {\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"blocks_and_items/items/equipment/tincture/healing/massive/open","model":"sbhp:tincture/health_5"}'\
                }\
            }\
        }\
    },\
