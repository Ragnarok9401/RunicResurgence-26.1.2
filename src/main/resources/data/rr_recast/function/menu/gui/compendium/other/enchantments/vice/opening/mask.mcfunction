...
[\
    ...
    {\
        ...
        "components":\
        {\
            "minecraft:item_name":{"text":"Opening","color":"dark_red"},\
            lore:[\
                {"color":"gray","italic":false,"text":"Your shield seems to have some"},\
                {"color":"gray","italic":false,"text":"holes in it. When blocking damage,"},\
                {"color":"gray","italic":false,"text":"half of it still transfers to you."},\
            ],\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"other/enchantments/vice/opening/open","model":"aea:book/opening_vice"}'\
                }\
            }\
        }\
    },\
