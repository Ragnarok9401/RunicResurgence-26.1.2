...
[\
    ...
    {\
        ...
        "components":\
        {\
            "minecraft:item_name":{"text":"Boomstick","color":"light_purple"},\
            lore:[\
                {"color":"gray","italic":false,"text":"Just add gunpowder!"},\
                {"color":"gray","italic":false,"text":"Boomstick turns your Crossbow"},\
                {"color":"gray","italic":false,"text":"into a close-range shredding"},\
                {"color":"gray","italic":false,"text":"machine of dastardly proportions."},\
            ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                {"color":"gray","italic":false,"text":"Each level of Boomstick adds"},\
                {"color":"gray","italic":false,"text":"some arrows to your Crossbow shot."},\
                {"color":"gray","italic":false,"text":"Every arrow fired can hit the same"},\
                {"color":"gray","italic":false,"text":"entity any amount of times."},\
                {"color":"gray","italic":false,"text":"However, your Crossbow will take"},\
                {"color":"gray","italic":false,"text":"much longer to charge."},\
                {"color":"gray","italic":false,"text":"Applicable on: "},\
                {"color":"white","italic":false,"text":"  Crossbows"},\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"other/enchantments/blessing/boomstick/open","model":"aea:book/boomstick_3"}'\
                }\
            }\
        }\
    },\
