...
[\
    ...
    {\
        ...
        "components":\
        {\
            "minecraft:item_name":{"text":"Extension","color":"white"},\
            item_model:"minecraft:enchanted_book",\
            "!minecraft:jukebox_playable":{},\
            "minecraft:stored_enchantments": {"rr_aea:extension":1},\
            tooltip_display: {hidden_components:["stored_enchantments"]},\
            "minecraft:enchantment_glint_override":true,\
            "minecraft:custom_data":\
            {\
                RunicMenuItem:{command:"function rr_recast:menu/gui/compendium/other/enchantments/regular/extension/open"}\
            }\
        }\
    },\
    {\
        ...
        "components":\
        {\
            "minecraft:item_name":{"text":"Aegis","color":"white"},\
            item_model:"minecraft:enchanted_book",\
            "!minecraft:jukebox_playable":{},\
            ...
            "minecraft:custom_data":\
            {\
                RunicMenuItem:{command:"function rr_recast:menu/gui/compendium/other/enchantments/regular/aegis/open"}\
            }\
        }\
    },\
    {\
