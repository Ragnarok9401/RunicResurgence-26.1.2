...
[\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                {"color":"gray","italic":false,"text":"A writhing hunk of Sculk flesh..."},\
                {"color":"gray","italic":false,"text":"Something nefarious lurks within."},\
                {"color":"gray","italic":false,"text":"The Necrosculker's power continues"},\
                {"color":"gray","italic":false,"text":"to grow darker."},\
                ],\
    ...
    {\
        ...
        {\
            ...
            lore:[\
                ...
                {"color":"gray","italic":false,"text":"forth an unforgiving foe."},\
            ],\
    ...
    {\
        ...
        {\
            tooltip_display:{hide_tooltip:true},\
            "minecraft:custom_data":{RunicMenuItem:{empty:1b}},\
            item_model:"minecraft:amethyst_cluster",\
            "!minecraft:jukebox_playable":{},\
        }\
    },\
    {\
    ...
    {\
        ...
        {\
            ...
            {\
                RunicMenuItem:\
                {\
                    command:'function rr_recast:menu/gui/compendium/home_with_return/open {"page":"blocks_and_items/items/boss_items/necrosculker/wrathful_dark_heart/open","model":"rr_recast:boss_item/necrosculker/wrathful_dark_heart"}'\
                }\
            }\
        }\
    },\
