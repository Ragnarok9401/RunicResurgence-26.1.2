...
# Tick Bosses if they are alive
execute as @e[type=marker,tag=rr.boss] at @s run function rr_recast:boss/generic/tick

# Manage Sneaking so that certain features only activate as soon as you sneak, not after holding it.
tag @a[predicate=!rr_recast:player_checks/sneaking] remove rr.player.sneaking_consecutive
tag @a[predicate=!rr_recast:player_checks/sneaking] remove rr.player.sneaking_initial
tag @a[predicate=rr_recast:player_checks/sneaking,tag=rr.player.sneaking_initial,tag=!rr.player.sneaking_consecutive] add rr.player.sneaking_consecutive
tag @a[predicate=rr_recast:player_checks/sneaking,tag=!rr.player.sneaking_initial,tag=!rr.player.sneaking_consecutive] add rr.player.sneaking_initial


# Manage Tomahawk scores for all players
execute as @a[tag=rr.player.using_tomahawk,predicate=rr_recast:held_items/any/equipment/weapon/tomahawk/netherite_tomahawk,advancements={rr_adv:equipment/weapon/tomahawk/use_netherite=false}] at @s run function rr_recast:equipment/weapon/tomahawk/netherite/not_using
execute as @a[tag=rr.player.using_tomahawk,predicate=rr_recast:held_items/any/equipment/weapon/tomahawk/netherite_tomahawk,advancements={rr_adv:equipment/weapon/tomahawk/use_netherite=true}] at @s run function rr_recast:equipment/weapon/tomahawk/netherite/check_using
execute as @a[tag=rr.player.using_tomahawk,predicate=rr_recast:held_items/any/equipment/weapon/tomahawk/diamond_tomahawk,advancements={rr_adv:equipment/weapon/tomahawk/use_diamond=false}] at @s run function rr_recast:equipment/weapon/tomahawk/diamond/not_using
execute as @a[tag=rr.player.using_tomahawk,predicate=rr_recast:held_items/any/equipment/weapon/tomahawk/diamond_tomahawk,advancements={rr_adv:equipment/weapon/tomahawk/use_diamond=true}] at @s run function rr_recast:equipment/weapon/tomahawk/diamond/check_using
execute as @a[tag=rr.player.using_tomahawk,predicate=rr_recast:held_items/any/equipment/weapon/tomahawk/golden_tomahawk,advancements={rr_adv:equipment/weapon/tomahawk/use_golden=false}] at @s run function rr_recast:equipment/weapon/tomahawk/golden/not_using
execute as @a[tag=rr.player.using_tomahawk,predicate=rr_recast:held_items/any/equipment/weapon/tomahawk/golden_tomahawk,advancements={rr_adv:equipment/weapon/tomahawk/use_golden=true}] at @s run function rr_recast:equipment/weapon/tomahawk/golden/check_using
execute as @a[tag=rr.player.using_tomahawk,predicate=rr_recast:held_items/any/equipment/weapon/tomahawk/iron_tomahawk,advancements={rr_adv:equipment/weapon/tomahawk/use_iron=false}] at @s run function rr_recast:equipment/weapon/tomahawk/iron/not_using
execute as @a[tag=rr.player.using_tomahawk,predicate=rr_recast:held_items/any/equipment/weapon/tomahawk/iron_tomahawk,advancements={rr_adv:equipment/weapon/tomahawk/use_iron=true}] at @s run function rr_recast:equipment/weapon/tomahawk/iron/check_using
execute as @a[tag=rr.player.using_tomahawk,predicate=rr_recast:held_items/any/equipment/weapon/tomahawk/stone_tomahawk,advancements={rr_adv:equipment/weapon/tomahawk/use_stone=false}] at @s run function rr_recast:equipment/weapon/tomahawk/stone/not_using
execute as @a[tag=rr.player.using_tomahawk,predicate=rr_recast:held_items/any/equipment/weapon/tomahawk/stone_tomahawk,advancements={rr_adv:equipment/weapon/tomahawk/use_stone=true}] at @s run function rr_recast:equipment/weapon/tomahawk/stone/check_using
execute as @a[tag=rr.player.using_tomahawk,predicate=rr_recast:held_items/any/equipment/weapon/tomahawk/wooden_tomahawk,advancements={rr_adv:equipment/weapon/tomahawk/use_wooden=false}] at @s run function rr_recast:equipment/weapon/tomahawk/wooden/not_using
execute as @a[tag=rr.player.using_tomahawk,predicate=rr_recast:held_items/any/equipment/weapon/tomahawk/wooden_tomahawk,advancements={rr_adv:equipment/weapon/tomahawk/use_wooden=true}] at @s run function rr_recast:equipment/weapon/tomahawk/wooden/check_using


# Tomahawk movement
execute as @e[tag=rr.tomahawk,type=item_display] at @s run function rr_recast:equipment/weapon/tomahawk/move with entity @s data.rr_recast
...
execute as @e[type=item_display,tag=RunicUI] run function rr_recast:menu/item_display/tick
