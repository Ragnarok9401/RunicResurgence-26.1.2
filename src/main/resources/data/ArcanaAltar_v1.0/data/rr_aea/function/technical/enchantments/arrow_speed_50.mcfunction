execute as @e[type=arrow,limit=1,sort=nearest,nbt={inGround:false},tag=!ArenSpdUpdated] store result entity @s data.aea.motion.x double 0.0001 run data get entity @s Motion[0] 15000
...
execute as @e[type=arrow,limit=1,sort=nearest,nbt={inGround:false},tag=!ArenSpdUpdated] store result entity @s data.aea.motion.y double 0.0001 run data get entity @s Motion[1] 15000
...
execute as @e[type=arrow,limit=1,sort=nearest,nbt={inGround:false},tag=!ArenSpdUpdated] store result entity @s data.aea.motion.z double 0.0001 run data get entity @s Motion[2] 15000
