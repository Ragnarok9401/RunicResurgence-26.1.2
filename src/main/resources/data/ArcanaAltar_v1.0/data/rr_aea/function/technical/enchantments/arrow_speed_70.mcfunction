execute as @e[type=arrow,limit=1,sort=nearest,nbt={inGround:false},tag=!ArenSpdUpdated] store result score @s aea.math.A run data get entity @s Motion[0] 17000
...
execute as @e[type=arrow,limit=1,sort=nearest,nbt={inGround:false},tag=!ArenSpdUpdated] store result score @s aea.math.J run data get entity @s Motion[1] 17000
...
execute as @e[type=arrow,limit=1,sort=nearest,nbt={inGround:false},tag=!ArenSpdUpdated] store result score @s aea.math.K run data get entity @s Motion[2] 17000
