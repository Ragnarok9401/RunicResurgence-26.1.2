...
execute as @n[type=marker,limit=1,sort=nearest,tag=ArenAEADTMain,distance=..5] if score @s aea.math.F matches 7 run data modify entity @n[type=item_display,tag=ArenAEAProtectionLvl,distance=..5] item.components.minecraft:item_model set value "aea:icon/level_7"
execute as @n[type=marker,limit=1,sort=nearest,tag=ArenAEADTMain,distance=..5] if score @s aea.math.F matches 6 run data modify entity @n[type=item_display,tag=ArenAEAProtectionLvl,distance=..5] item.components.minecraft:item_model set value "aea:icon/level_6"
execute as @n[type=marker,limit=1,sort=nearest,tag=ArenAEADTMain,distance=..5] if score @s aea.math.F matches 5 run data modify entity @n[type=item_display,tag=ArenAEAProtectionLvl,distance=..5] item.components.minecraft:item_model set value "aea:icon/level_5"
execute as @n[type=marker,limit=1,sort=nearest,tag=ArenAEADTMain,distance=..5] if score @s aea.math.F matches 4 run data modify entity @n[type=item_display,tag=ArenAEAProtectionLvl,distance=..5] item.components.minecraft:item_model set value "aea:icon/level_4"
execute as @n[type=marker,limit=1,sort=nearest,tag=ArenAEADTMain,distance=..5] if score @s aea.math.F matches 3 run data modify entity @n[type=item_display,tag=ArenAEAProtectionLvl,distance=..5] item.components.minecraft:item_model set value "aea:icon/level_3"
execute as @n[type=marker,limit=1,sort=nearest,tag=ArenAEADTMain,distance=..5] if score @s aea.math.F matches 2 run data modify entity @n[type=item_display,tag=ArenAEAProtectionLvl,distance=..5] item.components.minecraft:item_model set value "aea:icon/level_2"
execute as @n[type=marker,limit=1,sort=nearest,tag=ArenAEADTMain,distance=..5] if score @s aea.math.F matches 1 run data modify entity @n[type=item_display,tag=ArenAEAProtectionLvl,distance=..5] item.components.minecraft:item_model set value "aea:icon/level_1"
execute as @n[type=marker,limit=1,sort=nearest,tag=ArenAEADTMain,distance=..5] if score @s aea.math.F matches 0 run data modify entity @n[type=item_display,tag=ArenAEAProtectionLvl,distance=..5] item.components.minecraft:item_model set value "aea:icon/level_0"

# Replace current interaction with a new one to refresh the Interaction timestamps
summon interaction ~ ~ ~ {width:0.25f,height:0.25f,response:true,Tags:[aea.altar.entity,"ArenAEAProtectionDown1","ArenAEAIMain"]}
kill @s