...
execute as @s at @s run kill @e[type=text_display,tag=ArenAEAReboundLvlText,distance=..5]
execute as @s at @s run kill @e[type=item_display,tag=ArenAEAReboundLvl,distance=..5]
execute as @s at @s run kill @e[type=item_display,tag=ArenAEAReboundUp1,distance=..5]
execute as @s at @s run kill @e[type=item_display,tag=ArenAEAReboundUp2,distance=..5]
execute as @s at @s run kill @e[type=item_display,tag=ArenAEAReboundDown1,distance=..5]
execute as @s at @s run kill @e[type=item_display,tag=ArenAEAReboundDown2,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAReboundUp1,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAReboundUp2,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAReboundDown1,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAReboundDown2,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAReboundConfirm,distance=..5]
execute as @s at @s run kill @e[type=interaction,tag=ArenAEAReboundConfirm2,distance=..5]
