...
#region
## Initialize Math A Score to 10000, representing 100.0% of healing being applied
...
scoreboard players set @s[predicate=sbhp:player/running,nbt=!{active_effects:[{id:"minecraft:nausea"}]}] sbhp.math.B 7
...
scoreboard players set @s[predicate=sbhp:player/running,nbt=!{active_effects:[{id:"minecraft:nausea"}]}] sbhp.math.B 10
scoreboard players operation @s[predicate=sbhp:player/running,nbt=!{active_effects:[{id:"minecraft:nausea"}]}] sbhp.math.A /= @s sbhp.math.B

### If Nausea effect is active, sprinting reduces healing by 50%
scoreboard players set @s[predicate=sbhp:player/running,nbt={active_effects:[{id:"minecraft:nausea"}]}] sbhp.math.B 5
scoreboard players operation @s[predicate=sbhp:player/running,nbt={active_effects:[{id:"minecraft:nausea"}]}] sbhp.math.A *= @s sbhp.math.B
scoreboard players set @s[predicate=sbhp:player/running,nbt={active_effects:[{id:"minecraft:nausea"}]}] sbhp.math.B 10
scoreboard players operation @s[predicate=sbhp:player/running,nbt={active_effects:[{id:"minecraft:nausea"}]}] sbhp.math.A /= @s sbhp.math.B
...
### Regeneration Effect (should be last) is an *absolute increase* (meaning it cannot be modified) of 0.8% of Max Health per level
...
execute as @s[scores={sbhp.math.C=0..}] run scoreboard players set @s sbhp.math.B 8
