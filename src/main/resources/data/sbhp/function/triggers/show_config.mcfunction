tellraw @s [\
    ...
    {"text":"BaseDmgMod","color":"gold","hover_event":{"action":"show_text","value":[\
        {"text":"Base Damage Modification (default is\n110%--or +10%--damage taken overall)","color":"gray","italic":false}]}},{"text":": ","color":"gold"},{"score":{"name":"$config","objective":"sbhp.config.BaseDmgMod"},"color":"gold"},{"text":"\n"},\
    ...
    {"text":"DmgIndOn","color":"gold","hover_event":{"action":"show_text","value":[\
        {"text":"If damage numbers should show\nabove players who take damage\n0 = False | 1 = True","color":"gray","italic":false}]}},{"text":": ","color":"red"},{"score":{"name":"$config","objective":"sbhp.config.DmgIndOn"},"color":"gold"},{"text":"\n"},\
